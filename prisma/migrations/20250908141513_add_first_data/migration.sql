...
CREATE TABLE "public"."Teacher" (
    ...
    "teacher_servant" TEXT NOT NULL,
    "teacher_goverment" TEXT NOT NULL,
    "teacher_employee" TEXT NOT NULL,
    "total_all" TEXT NOT NULL,
...
CREATE TABLE "public"."Cct" (
    ...
    "moe_code" INTEGER NOT NULL,
    "school_name" TEXT NOT NULL,
    "p_register_dmc" TEXT NOT NULL,
    "p_register_cct" TEXT NOT NULL,
    "p_screen" TEXT NOT NULL,
    "p_receive" TEXT NOT NULL,
    "p_poor" TEXT NOT NULL,
    "p_ex_poor" TEXT NOT NULL,
    "p_budget" TEXT NOT NULL,
    "m_register_dmc" TEXT NOT NULL,
    "m_register_cct" TEXT NOT NULL,
    "m_screen" TEXT NOT NULL,
    "m_receive" TEXT NOT NULL,
    "m_poor" TEXT NOT NULL,
    "m_ex_poor" TEXT NOT NULL,
    "m_budget" TEXT NOT NULL,
    "budget_total" TEXT NOT NULL,

    CONSTRAINT "Cct_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."Teacher" ADD CONSTRAINT "Teacher_smis_code_fkey" FOREIGN KEY ("smis_code") REFERENCES "public"."School"("smis_code") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Cct" ADD CONSTRAINT "Cct_smis_code_fkey" FOREIGN KEY ("smis_code") REFERENCES "public"."School"("smis_code") ON DELETE RESTRICT ON UPDATE CASCADE;
